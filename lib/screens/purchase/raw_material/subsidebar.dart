    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _menuItem(Icons.shopping_bag_outlined, "Purchase Order", isActive: activePage == 'Purchase Order'),
          _menuItem(Icons.shopping_cart_outlined, "Purchase Entry", isActive: activePage == 'Purchase Entry'),
          _menuItem(Icons.receipt_long_outlined, "Invoice Management", isActive: activePage == 'Invoice Management'),
          _menuItem(Icons.pie_chart_outline, "Section Wise\nConsumption", isActive: activePage == 'Section Wise Consumption'),
          _menuItem(Icons.assignment_outlined, "Inventory Audit Entry", isActive: activePage == 'Inventory Audit Entry'),
        ],
      ),
    );
  }

  Widget _menuItem(IconData icon, String text, {bool isActive = false}) {
    return Container(
